...
[{biru_m}*{hapus}] Ketik 'me' jika ingin crack dari daftar teman anda."""))
    ...
    def followers(self, cok, tok):
        try:
            ...
            tol = self.ses.get(f"https://graph.facebook.com/{uid.get('uid')}?fields=name,subscribers.fields(id,name,username).limit(1000000000)&access_token={tok}",cookies=cok).json()
